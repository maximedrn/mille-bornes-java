 ...
 */
public class OrderedDatabaseList<T extends OrderedDatabaseTable<?>> 
    extends DatabaseList<T> 
{

    public OrderedDatabaseList() {
        super();
    }

    public OrderedDatabaseList(final Collection<T> entities) {
        super(entities);
        this.sort();
    }
